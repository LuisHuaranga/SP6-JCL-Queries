//S38457LH JOB ,LHG,CLASS=9,REGION=0M,
...
//DATO01   DD DSN=&AMB..PPS.G01SN.PPS.REVERSE.PPST001,
...
//SYSOUT   DD SYSOUT=*    
//SYSPRINT DD DSN=&AMB..PPS.G01SN.PPS.REVERSE.PPST001,            
//            DISP=(NEW,CATLG,DELETE),                             
//            SPACE=(CYL,(1,1),RLSE),UNIT=SYSDA,          
//            DCB=(RECFM=FB,DSORG=PS)   
//SYSTSIN  DD DISP=SHR,DSN=&PARMLIB(DSNTEP2)
//SYSIN    DD DSN=D.PPS.G01SN.PPS.QUERYDES.REVERSE.PPST001,
//            DISP=SHR
//*