//**********************************************************************
//*   * 515856 15/09/25 LHG MEMBRESIAS PPS CON DNI INCORRECTO         *
//**********************************************************************
//PPSP910 PROC
//*--------------------------------------------------------------------*
...
//SORTIN    DD DSN=&AMB..PPS.G01SN.PPS.PPSP438.ALTAPDT.VARIABLE,
//             DISP=SHR
...
//SYSOUT    DD SYSOUT=&OUTS
//SYSPRINT  DD SYSOUT=&OUTS
//SORTIN    DD DSN=&AMB..PPS.G01SN.PPS.PPSP170.PPST001.UNLOAD,DISP=SHR
...
//SYSOUT    DD SYSOUT=&OUTS
//SYSPRINT  DD SYSOUT=&OUTS
//SORTIN    DD DSN=&AMB..PPS.&GRPB.SN.PPS.PPSP910.SAL01.PCHOST,DISP=SHR
...
//*
//*--------------------------------------------------------------------*
//* STEP 09: BORRADO ARCHIVO PPST002.UNLOAD                            *
//*--------------------------------------------------------------------*
//S09PIEFB  EXEC PGM=IEFBR14,COND=(04,LT)
//SYSUT1    DD DSN=&AMB..PPS.&GRPB.SN.PPS.PPSP910.PPST002.UNLOAD,
//             DISP=(MOD,DELETE),UNIT=SYSDA,SPACE=(CYL,0)
//*--------------------------------------------------------------------*
//* STEP 10: DESCARGA DE  LA TABLA CDDTPPS2                            *
//*--------------------------------------------------------------------*
//S04PINZU EXEC PROC=INZUTIL5,DYNAMNBR=99,COND=(04,LT),
//         PARM='&DB2DSN,PPSP910.ULD1'
//SYSPRINT  DD SYSOUT=&OUTS
//SYSREC00  DD DSN=&AMB..PPS.&GRPB.SN.PPS.PPSP910.PPST002.UNLOAD,
//             DISP=(NEW,CATLG,DELETE),UNIT=SYSDA,
//             SPACE=(CYL,(800,200),RLSE)
//SYSPUNCH  DD SYSOUT=&OUTS
//SYSIN     DD DSN=&PARMLIB(PPSU910A),DISP=SHR
//*--------------------------------------------------------------------*
...
//SYSOUT    DD SYSOUT=&OUTS
//SYSPRINT  DD SYSOUT=&OUTS
//SORTIN    DD DSN=&AMB..PPS.&GRPB.SN.PPS.PPSP910.PPST002.UNLOAD,
//             DISP=SHR
